(() => {
  ...
  const STORAGE_PREFIX = 'ofb_mini_app_cache_v5:';
  ...
  function renderDashboard(dashboard, fromCache = false) {
    ...
    renderStats(dashboard.stats || null);
  ...
  function switchTab(tab) {
    ...
    if (tab === 'squad') loadSquad().catch(console.error);
    if (tab === 'transfers') loadTransfers().catch(console.error);
  }
