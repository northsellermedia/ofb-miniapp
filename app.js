(() => {
  ...
  function bindSubscribeButtonTap() {
    ...
    btn.addEventListener('touchend', (e) => run('button_touchend', e), { passive: false });
    btn.addEventListener('pointerup', (e) => {
      if (e.pointerType === 'touch') run('button_pointerup', e);
    }, { passive: false });
    btn.addEventListener('click', (e) => run('button_click', e));
  }
